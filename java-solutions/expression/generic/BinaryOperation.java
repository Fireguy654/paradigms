...
public abstract class BinaryOperation<T extends Calculable<T>> implements GenericExpression<T> {
    private final GenericExpression<T> arg1;
    private final GenericExpression<T> arg2;

    public BinaryOperation(GenericExpression<T> arg1, GenericExpression<T> arg2) {
        this.arg1 = arg1;
        this.arg2 = arg2;
    }
    ...
    public abstract T doOperation(T fir, T sec);
